...
namespace PrimeraPruebaUnitaria
{
    public class Persona : IPersona
    {
        ...
        public void copiaPersona(IPersona p1)
        {
            this.nombre = p1.getNombre();
            this.apellido = p1.getApellido();
        ...
        public void conseguirPareja(IPersona p)
        {
            this.pareja = (Persona)p;
        }

        public void dejarPareja(IPersona p)
        {
            this.pareja = null;
        }
